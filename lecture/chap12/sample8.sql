...
--      집합인 오라클 객체
--  나. 실제 회사에서는, 급여관리/인사관리/재고관리 등, 다양한
...
-- 3-2. 패키지.함수(전달인자값) 호출
SELECT ename, mypackage.mylower(ename)
FROM emp;


SELECT mypackage.circleArea(4.7)
FROM dual;

-- ------------------------------------------------------
-- 8-4. PL/SQL 패키지: 패키지 삭제
-- ------------------------------------------------------
--  Basic syntax: 
--
--      1) 패키지 구현 삭제: DROP PACKAGE BODY <삭제할 패키지명>;
--      2) 패키지 선언 삭제: DROP PACKAGE <삭제할 패키지명>;
-- ------------------------------------------------------
